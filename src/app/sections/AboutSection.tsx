...
const AboutSection = () => {
    return <section id="about-section" className="container-wrapper flex justify-between items-center py-20 flex-col lg:flex-row">
        ...
        <div className='w-full lg:w-[45%] transition-all ease-in flex flex-col items-center lg:items-start gap-5 text-center lg:text-justify'>
            ...
            <p className="text-greyColor font-roboto font-medium text-lg">Proficiency as well in mobile application development, with using flutter i write quality code and build responsive and efficient app, helping businesses bring thier idea into reality, increasing sales metrices.</p>
            <p className="text-greyColor font-roboto font-medium text-lg">In addition to my front-end skills, I am proficient in server-side languages like DJANGO and database management systems such as MySQL and PostgreSQL. My integrated approach ensures seamless functionality for web applications, and I am committed to delivering robust and scalable solutions that drive success for my clients.</p>
            <div className="flex gap-2 flex-wrap justify-center lg:justify-start">
                ...
                <div className="bg-shade py-2 px-4 rounded-full cursor-pointer hover:bg-primary/70">dart</div>
                ...
                <div className="bg-shade py-2 px-4 rounded-full cursor-pointer hover:bg-primary/70">Postgresql</div>
            </div>
