...
const ProjectUpload = () => {
    ...
    const uploadToCloudinary = async (file: File): Promise<string> => {
        ...
        formData.append('upload_preset', 'portfolio'); // change this
        formData.append('cloud_name', 'dngslqprl'); // optional, not needed in unsigned requests
      
        const response = await fetch(`https://api.cloudinary.com/v1_1/dngslqprl/image/upload`, {
          method: 'POST',
          body: formData,
        });
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        try {
            ...
            // router.push('/'); // optionally go back
